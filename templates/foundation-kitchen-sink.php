<?php
/*
Template Name: Foundation Kitchen Sink
*/
?>
...
<article <?php post_class(); ?> >
			...
			<div class="inner">
				...
				<h1><a href="<?php the_permalink() ?>" rel="bookmark">H1 Title</a></h1>
				...
				<div class="entry">
					...
					<div class="panel">
						<ul class="kitchen-sink-nav row">
							<li class="columns small-4 medium-3"><a href="#alert-boxes">Alert Boxes</a></li>
							<li class="columns small-4 medium-3"><a href="#block-grid">Block Grid</a></li>
							<li class="columns small-4 medium-3"><a href="#breadcrumbs">Breadcrumbs</a></li>
							<li class="columns small-4 medium-3"><a href="#buttons">Buttons</a></li>
							<li class="columns small-4 medium-3"><a href="#button-groups">Button Groups</a></li>
							<li class="columns small-4 medium-3"><a href="#dropdown-buttons">Dropdown Buttons</a></li>
							<li class="columns small-4 medium-3"><a href="#split-buttons">Split Buttons</a></li>
							<li class="columns small-4 medium-3"><a href="#clearing">Clearing</a></li>
							<li class="columns small-4 medium-3"><a href="#forms">Forms</a></li>
							<li class="columns small-4 medium-3"><a href="#dropdowns">Dropdowns</a></li>
							<li class="columns small-4 medium-3"><a href="#flex-video">Flex Video</a></li>
							<li class="columns small-4 medium-3"><a href="#inline-lists">Inline Lists</a></li>
							<li class="columns small-4 medium-3"><a href="#joyride">Joyride</a></li>
							<li class="columns small-4 medium-3"><a href="#keystroke">Keystroke</a></li>
							<li class="columns small-4 medium-3"><a href="#labels">Labels</a></li>
							<li class="columns small-4 medium-3"><a href="#magellan">Magellan</a></li>
							<li class="columns small-4 medium-3"><a href="#orbit">Orbit</a></li>
							<li class="columns small-4 medium-3"><a href="#pagination">Pagination</a></li>
							<li class="columns small-4 medium-3"><a href="#panels">Panels</a></li>
							<li class="columns small-4 medium-3"><a href="#pricing-tables">Pricing Tables</a></li>
							<li class="columns small-4 medium-3"><a href="#progress-bars">Progress Bars</a></li>
							<li class="columns small-4 medium-3"><a href="#reveal">Reveal</a></li>
							<li class="columns small-4 medium-3"><a href="#accordion">Accordion</a></li>
							<li class="columns small-4 medium-3"><a href="#tabs">Tabs</a></li>
							<li class="columns small-4 medium-3"><a href="#side-nav">Side Nav</a></li>
							<li class="columns small-4 medium-3"><a href="#sub-nav">Sub Nav</a></li>
							<li class="columns small-4 medium-3"><a href="#tables">Tables</a></li>
							<li class="columns small-4 medium-3"><a href="#thumbnails">Thumbnails</a></li>
							<li class="columns small-4 medium-3"><a href="#tooltips">Tooltips</a></li>
							<li class="columns small-4 medium-3"><a href="#top-bar">Top Bar</a></li>
							<li class="columns small-4 medium-3"><a href="#type">Type</a></li>
							<li class="columns small-4 medium-3"><a href="#visibility-classes">Visibility Classes</a></li>
						</ul>
					</div>
					...
					<ul class="small-block-grid-2 large-block-grid-4">
					  <li><img class="th" src="<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/comet-th.jpg"></li>
					  <li><img class="th" src="<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/launch-th.jpg"></li>
					  <li><img class="th" src="<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/space-th.jpg"></li>
					  <li><img class="th" src="<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/spacewalk-th.jpg"></li>
					</ul>
					...
					<div>
					  <ul class="clearing-thumbs" data-clearing>
					    <li><a class="th" href="<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/comet.jpg"><img data-caption="Nulla vitae elit libero, a pharetra augue. Cras mattis consectetur purus sit amet fermentum." src="<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/comet-th-sm.jpg"></a></li>

					    <li><a class="th" href="<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/earth.jpg"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/earth-th-sm.jpg"></a></li>

					    <li><a class="th" href="<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/launch.jpg"><img data-caption="Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus." src="<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/launch-th-sm.jpg"></a></li>

					    <li><a class="th" href="<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/satelite.jpg"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/satelite-th-sm.jpg"></a></li>

					    <li><a class="th" href="<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/space.jpg"><img data-caption="Integer posuere erat a ante venenatis dapibus posuere velit aliquet." src="<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/space-th-sm.jpg"></a></li>
					  </ul>
					</div>
					...
					<p><a class="button" data-dropdown="tinyDrop" href="#">Link Dropdown &raquo;</a>
					  ...
					  "contentDrop">
					    ...
					    "<?php echo get_stylesheet_directory_uri(); ?>/images/foundation/examples/launch.jpg">
